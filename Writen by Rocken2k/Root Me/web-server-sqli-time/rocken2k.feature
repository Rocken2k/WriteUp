...
Feature: SQL injection - Time based
  ...
  Scenario: SQL injection through the URL
    ...
    Then I see the parameter is being passed through the URL [evidence](3.png)
  ...
  Scenario: Success: Using SQLmap
    ...
    Then I look up on google how to exploit time-based sqli
    And I discover I can use the flag "--time-sec" in SQLmap
    ...
    Then I can see the name of the current database [evidence](4.png)
    And I discover a SQLI vulnerability
    And to find the name of the current table I use the following script
    """
    sqlmap -u "http://challenge01.root-me.org/web-serveur/ch40/?action=member
